...
from beir.datasets.data_loader_fashioniq import DataLoader
...
from beir.hybrid.data_ingestor_multimodal_fashioniq import OpenSearchDataIngestor_FashionIq
...
def ingest_data(corpus, endpoint, index, port, static_content_folder, corpus_method="text", shift_corpus=0):
    OpenSearchDataIngestor_FashionIq(endpoint, port, static_content_folder).ingest(corpus, index=index, corpus_method=corpus_method, shift_corpus=shift_corpus)
